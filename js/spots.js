...
(function (global) {
  ...
  var BASE_SPOTS = Object.freeze([
    normalizeSpot({ id: 'hamada', name: 'えびふらい抹茶専門店　はま田', latitude: 35.005807, longitude: 136.2810556, radiusMeters: 120, category: 'gourmet', description: '明治時代に建てられた古民家で、大きなえびふらいと抹茶を楽しめる店。', guide: '営業日・利用方法を確認し、店舗利用者や近隣の迷惑にならない場所でARを楽しもう。', spawnCharacterIds: ['ebi-maru', 'tart-chan', 'lemon-pyon', 'koromo-pon', 'queen-tartar'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.biwako-visitors.jp/spot/detail/30664/' }, 'base'),
