...
(function (global) {
  ...
  var BASE_SPOTS = Object.freeze([
    normalizeSpot({ id: 'hamada', name: 'えびふらいと抹茶専門店 はま田', latitude: 35.005807, longitude: 136.2810556, radiusMeters: 120, category: 'gourmet', description: '明治時代に建てられた古民家で、大きなえびふらいと抹茶を楽しめる店。', guide: '営業日・利用方法を確認し、店舗利用者や近隣の迷惑にならない場所でARを楽しもう。', spawnCharacterIds: ['ebi-maru', 'tart-chan', 'lemon-pyon', 'koromo-pon', 'midori-furai'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.biwako-visitors.jp/spot/detail/30664/' }, 'base'),
    ...
    normalizeSpot({ id: 'watamuki-jinja', name: '村社綿向神社', latitude: 35.0068, longitude: 136.2572, radiusMeters: 160, category: 'shrine', description: '地域の人々に大切に守られてきた綿向神社。わたむきえびが見守る冒険スポット。', guide: '地域の祭事・参拝を優先し、敷地内のルールを守りましょう。', spawnCharacterIds: ['watamuki-ebi'], eventOnly: false, isPublished: true, sourceUrl: 'https://hino-kanko.jp/sight/' }, 'base'),
