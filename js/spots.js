...
(function (global) {
  ...
  var BASE_SPOTS = Object.freeze([
    normalizeSpot({ id: 'hamada', name: 'えびふらいと抹茶専門店 はま田', latitude: 35.005807, longitude: 136.2810556, radiusMeters: 120, category: 'gourmet', description: '明治時代に建てられた古民家で、大きなえびふらいと抹茶を楽しめる店。', guide: '営業日・利用方法を確認し、店舗利用者や近隣の迷惑にならない場所でARを楽しもう。', spawnCharacterIds: ['ebi-maru', 'tart-chan', 'lemon-pyon', 'koromo-pon', 'queen-tartar'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.biwako-visitors.jp/spot/detail/30664/' }, 'base'),
    normalizeSpot({ id: 'umamioka-watamuki-shrine', name: '馬見岡綿向神社', latitude: 35.01492234030106, longitude: 136.26190217677754, radiusMeters: 180, category: 'shrine', description: '湖東の大宮として信仰を集め、日野祭の舞台としても知られる神社。', guide: '参拝・祭事を最優先にし、境内の撮影・通行ルールに従おう。', spawnCharacterIds: ['festival-ebi', 'castle-crisp', 'queen-tartar', 'machi-akari', 'watamuki-ebi'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.biwako-visitors.jp/spot/detail/241/' }, 'base'),
    ...
    normalizeSpot({ id: 'hino-machikado-kanno', name: '日野まちかど感応館', latitude: 35.0112, longitude: 136.2471, radiusMeters: 160, category: 'tourism', description: '旧薬店を活用した観光交流拠点。薬業資料、観光案内、特産品販売がある。', guide: 'まちなか散策の出発点。館内の案内と営業情報を確認してから歩こう。', spawnCharacterIds: ['ebi-maru', 'machi-akari', 'shonin-ebi'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.town.shiga-hino.lg.jp/0000003689.html' }, 'base'),
    normalizeSpot({ id: 'hino-station', name: '近江鉄道 日野駅', latitude: 35.01229988576109, longitude: 136.21956617801249, radiusMeters: 160, category: 'tourism', description: '近江鉄道本線の日野駅。日野町を鉄道で巡る冒険の玄関口。', guide: '列車・駅利用者を優先し、ホームや線路付近ではARを起動しないでください。', spawnCharacterIds: ['rail-furai'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.ohmitetudo.co.jp/railway/ride/station/hino/' }, 'base'),
    normalizeSpot({ id: 'gamo-ujisato-statue', name: '蒲生氏郷公像', latitude: 35.01524627084247, longitude: 136.23819139901977, radiusMeters: 220, category: 'history', description: '日野町ひばり野に建つ、蒲生氏郷公を顕彰する像。', guide: '公園・周辺利用者を優先し、道路上では立ち止まらないでください。', spawnCharacterIds: ['castle-crisp', 'hino-gold', 'king-furai'], eventOnly: false, isPublished: true, sourceUrl: 'https://hino-kanko.jp/sight/gamouujisato/' }, 'base'),
    normalizeSpot({ id: 'nakano-castle-ruins', name: '中野城跡', latitude: 35.00899142295758, longitude: 136.26389435298356, radiusMeters: 350, category: 'history', description: '蒲生氏の居城として築かれ、日野城とも呼ばれる城跡。', guide: '史跡の保存と安全を最優先に。足元・天候を確認し、立入禁止箇所には入らないでください。', spawnCharacterIds: ['castle-crisp', 'satoyama-knight', 'king-furai', 'yamamori'], eventOnly: false, isPublished: true, sourceUrl: 'https://www.town.shiga-hino.lg.jp/0000004850.html' }, 'base'),
    ...
    normalizeSpot({ id: 'kishitsu-shrine', name: '鬼室神社', latitude: 35.030030815384634, longitude: 136.28442705215218, radiusMeters: 180, category: 'shrine', description: '百済から渡来した鬼室集斯にまつわる神社。日野町小野にある。', guide: '地域の信仰と交流の場です。参拝の妨げにならないよう、公開エリアで静かに楽しもう。', spawnCharacterIds: ['hino-bito', 'yamamori', 'kaze-ebi', 'midori-furai'], eventOnly: false, isPublished: true, sourceUrl: 'https://hino-kanko.jp/sight/kishitsujinjya/' }, 'base'),
    ...
    normalizeSpot({ id: 'watamuki-jinja', name: '村社綿向神社', latitude: 35.00657109831681, longitude: 136.28077055180452, radiusMeters: 160, category: 'shrine', description: '地域の人々に大切に守られてきた綿向神社。わたむきえびが見守る冒険スポット。', guide: '地域の祭事・参拝を優先し、敷地内のルールを守りましょう。', spawnCharacterIds: ['watamuki-ebi'], eventOnly: false, isPublished: true, sourceUrl: 'https://hino-kanko.jp/sight/' }, 'base'),
